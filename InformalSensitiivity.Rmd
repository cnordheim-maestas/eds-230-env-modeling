...
varying efficiency aka `ethresh`
...
eff
site2 = eff %>% 
  map(~solarpv( area=0.1, solar=sierraczosolar, clr="green", eunit="W", g=FALSE, etype="direct", eff=.x )) # eff = .x ??
...
head(site2) # this is a list of stuff...hard to get info out of this
